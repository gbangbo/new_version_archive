...
import { CommonFeaturedTutorialsComponent } from "../flash-info/widgets/common-featured-tutorials/common-featured-tutorials.component";
import { CommonArticleVideoComponent } from "../flash-info/widgets/common-article-video/common-article-video.component";
import { articlesAndVideosDetails, featuredTutorialDetails, knowledgeBase } from '../../shared/data/knowledge-base';
import { CommonFaqDetailsComponent } from "../flash-info/widgets/common-faq-details/common-faq-details.component";
