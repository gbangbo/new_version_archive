...
@Component({
    ...
    imports: [CommonModule, FormsModule, NzTableModule, NzTagModule, NzToolTipModule, CardComponent, FeatherIconComponent],
...
export class DomaineComponent implements OnInit {
    ...
    form: {
        ...
        description: string;
        is_active: boolean;
    } = {domain: '', description: '', is_active: true};
    ...
    loadDomaines(): void {
        ...
        this.httService.getData(
            ...
            .then((res: any) => {
                ...
                console.log('io-allowed-domains ===', res.body);
            ...
            html: `
              <div style="margin-top:8px;">
                ...
                <p style="font-size:13px;color:#64748B;margin:0;">
                  « <strong>${row.domain}</strong> » sera définitivement supprimé.
                </p>
              </div>`,
            icon: 'warning',
